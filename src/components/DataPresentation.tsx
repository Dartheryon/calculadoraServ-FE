...
const DataPresentation = ({
  ...
  return <>
    ...
    {!isMessageReady ? <SerialCodes />
      : (
        <div className='flex flex-col'>
          <h2 className='text-center text-3xl mx-5 my-3 text-black'>Toca el siguiente texto para copiarlo y poder enviarlo a los destinatarios</h2>
